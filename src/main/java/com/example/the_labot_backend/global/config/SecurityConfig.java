    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/admin/**").hasRole(Role.ROLE_ADMIN.name())       //본사관리자
                        .requestMatchers("/api/manager/**").hasRole(Role.ROLE_MANAGER.name())   //현장관리자
                        .requestMatchers("/api/worker/**").hasRole(Role.ROLE_WORKER.name())     //현장근로자
